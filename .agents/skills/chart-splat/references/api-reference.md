...
|-------|------|----------|---------|-------------|
| `type` | string | No | `line` | Chart type: `line`, `bar`, `pie`, `doughnut`, `radar`, `polarArea` |
| `data.labels` | string[] | Yes | - | Labels for X-axis or chart segments |
...
|-------|------|----------|-------------|
| `data` | number[] | Yes | Numeric data points |
...
| 400 | `Invalid chart configuration` | Missing `data.labels` or `data.datasets` |
