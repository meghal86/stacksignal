...
> Automated tech news digest — 137 sources, 5-layer pipeline, one chat message to install.
...
A quality-scored, deduplicated tech digest built from **137 sources**:
...
- `config/defaults/sources.json` — 137 built-in sources
